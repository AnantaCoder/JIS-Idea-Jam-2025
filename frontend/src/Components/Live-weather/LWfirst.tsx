...
import { fetchLiveWeather } from "./APIcall.ts";
                    ...
                    <div className="md:flex-1 p-6 md:p-8 items-center bg-gray-700">
                        ...
                        {result ? (
                            result.error ? (
                                ...
                                <div className="bg-gray-600 p-6 rounded-lg">
                                    <img src={result.condition.icon.replace("64x64", "128x128")} alt="Weather Image" />
                                    <p className="text-4xl font-bold text-green-400 mb-2">{result.condition.text}</p>
